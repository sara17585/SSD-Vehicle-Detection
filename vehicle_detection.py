...
from ssd_util import load_dataset_list, show_loss, show_log
...
if __name__ == '__main__':
    ...
    config = {'is_gpu': False,
              ...
              'lr': 0.001,
              'max_epoch': 150,
              'save_epochs': [5, 10, 15, 20, 30, 50, 70, 90, 120, 140],
              ...
              'is_train': True,
              'is_test': True,
              'results_path': '/home/suhongk/sfuhome/CMPT742/Lab3/vehicle_detection_v2/results/SSD__24th_07:11_epoch_90__model.pth'
              }
